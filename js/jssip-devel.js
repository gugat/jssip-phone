...
/*
 * Downloaded 2013.10.02 executing "wget jssip.net/download/jssip-devel.js".
 * Edited with change #3 shown here: https://groups.google.com/forum/#!topic/jssip/wXWrcBYHJ28
 * Tested against Freeswitch with Webrtc support, in Chrome and Firefox, using WSS connection (Secure WebSocket).
 * 
 * 
 * 
 * 
  ...
  */
  init: function(constraints) {
    ...
    this.peerConnection.onaddstream = function(e) {
      ...
      document.getElementById("remote-media").mozSrcObject = e.stream; 
    };
  ...
  getUserMedia: function(onSuccess, onFailure, constraints) {
    ...
    JsSIP.WebRTC.getUserMedia(constraints,
      function(stream) {
        ...
        onSuccess(stream);
        // document.getElementById("local-media").mozSrcObject = stream; 
      },
      function(e) {
